...
export default function InsertProduct() {
    ...
    const addProduct = async (e) => {
        ...
        try {
            // const res = await fetch("http://104.248.193.10:5000/insertproduct", {
            const res = await fetch(`http://${backendUrl}/insertproduct`, {
                // const res = await fetch(`http://backend-service.devshack-ns.svc.cluster.local:5000/insertproduct`, {

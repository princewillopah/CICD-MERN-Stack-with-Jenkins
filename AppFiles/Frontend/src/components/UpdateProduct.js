    ...
    useEffect(() => {
        const getProduct = async () => {
          ...
          try {
            ...
            // const res = await fetch(`http://backend-service.devshack-ns.svc.cluster.local:5000/products/${id}`, {
              method: "GET",
              headers: {
    ...
    const updateProduct = async (e) => {
        ...
        try {
            const response = await fetch(`http://${backendUrl}/updateproduct/${id}`, {
                // const response = await fetch(` http://backend-service.devshack-ns.svc.cluster.local:5000/updateproduct/${id}`, {
